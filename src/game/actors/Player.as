package game.actors
{
	...
	public class Player extends FlxSprite
	{
		...
		protected static const JUMP_MAX:Number = 260;
		protected static const JUMP_MIN:Number = 160;
		...
		public override function update():void
		{
            ...
            var shooted:Boolean = false;
            
			if (false == FlxG.mobile)
			{
                if (FlxG.mouse.justPressed() && hover(0, 20, FlxG.width/2, FlxG.height - 20) && !Registry.paused)
                {
                    shooted = true;
                }
                //jump
				if (FlxG.mouse.justPressed() && hover(FlxG.width/2, 20, FlxG.width/2, FlxG.height - 20) && !Registry.paused)
				{
					justPressed = true;
				}
				if (FlxG.mouse.pressed() && hover(FlxG.width/2, 20, FlxG.width/2, FlxG.height - 20) && !Registry.paused)
				{
					pressed = true;
				}
			}
